        ...
        <div className="grid grid-cols-[1fr_320px] gap-5">
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-[15px] font-bold text-gray-900">Hoạt động gần đây</h3>
              <button onClick={() => navigate('/admin/history')} className="text-xs text-[#1a7a4a] font-medium hover:underline bg-none border-none">Xem toàn bộ</button>
            </div>
