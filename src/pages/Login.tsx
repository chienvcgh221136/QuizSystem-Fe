...
const LoginPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0C451E] via-[#1B8F3D] to-[#23b14d] flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-[420px] bg-white rounded-[2rem] shadow-2xl overflow-hidden relative z-10 p-10">
        <div className="flex flex-col items-center mb-8">
          <div className="w-16 h-16 rounded-2xl bg-green-50 flex items-center justify-center text-[#1B8F3D] mb-5 shadow-sm border border-green-100">
            <BookOpen size={32} />
          </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          <div className="flex flex-col gap-1.5">
            ...
            <div className="relative group">
              <User size={16} className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-[#1B8F3D] transition-colors" />
              <input
                type="text"
                name="username"
                ...
                className="w-full pl-11 pr-5 py-3.5 border-2 border-gray-100 rounded-2xl text-sm font-semibold outline-none focus:border-[#1B8F3D] focus:ring-4 focus:ring-[#1B8F3D]/5 bg-gray-50/50 focus:bg-white transition-all placeholder:text-gray-300"
              />
            </div>
          </div>
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="relative group">
              <Lock size={16} className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-[#1B8F3D] transition-colors" />
              <input
                type="password"
                name="password"
